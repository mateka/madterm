...
int main()
{
    ...
    while (true) {
        ...
        std::cout << madterm::cursor::move_to(69_x, 10_y)
                  << madterm::text::erase_characters(27)
                  << madterm::cursor::move_to(69_x, 11_y)
                  << madterm::text::erase_characters(27)
                  << madterm::cursor::move_to(69_x, 12_y)
                  << madterm::text::erase_characters(27) << madterm::text::lines
                  << frame(68_x, 9_y, 27_x, 4_y) << madterm::text::ascii
                  << madterm::cursor::move_to(70_x, 12_y) << std::ctime(&time)
                  << madterm::cursor::move_to(80_x, 10_y)
                  << "Time:" << std::flush;
