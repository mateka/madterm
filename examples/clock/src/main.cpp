...
int main()
{
    ...
    std::cout << madterm::enable_formatting << madterm::screen_buffer::alternate
              ...
              << madterm::text::background_colour(75_r, 75_g, 75_b) << "Test builder"
              << madterm::text::clear_formatting
              << madterm::cursor::blink(false) << madterm::cursor::show(false)
              << madterm::window::title("clock") << " " << std::endl;
    while (true) {
        std::cout << madterm::text::lines << madterm::cursor::move_to(68_x, 9_y)
        ...
        std::cout << madterm::text::shapes::top_right_corner
                  ...
                  << madterm::text::shapes::vline << madterm::cursor::move_to(68_x, 13_y) << madterm::text::shapes::bottom_left_corner;
        for (int i = 0; i < 19; ++i)
            std::cout << madterm::text::shapes::hline;
        ...
        std::cout << madterm::cursor::move_to(69_x, 12_y)
                  ...
                  << std::put_time(&tm, "%c")
                  << madterm::cursor::move_to(75_x, 10_y)
                  << "Time:" << std::flush;
